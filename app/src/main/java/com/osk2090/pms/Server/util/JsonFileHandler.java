package com.osk2090.pms.Server.util;
...
public class JsonFileHandler {
    ...
    public static <T> List<T> loadClients(File file, Class<T> elementType) {
    ...
    public static <T> void saveClients(File file, List<T> list) {
